...
class WeiboSpider(scrapy.Spider):
    ...
    def parse(self, response):
        print(response)
        sub_name_list = []
        for line in open("E:\workspace\scrapy-project\gov\\image.txt", "r", encoding="utf-8"):
...
'''
user_id = 2685910793
cookie = {"Cookie": "_T_WM=e5771705e1485400ab9298436e50b4c0; expires=Sat, 06-Apr-2019 10:15:48 GMT; path=/; domain=.weibo.cn; httponly"}
